...
%if %{isaix}
	...
	%define _docdir %{_prefix}/doc/%{name}-%{version}
...
%endif
%doc LEGAL README.md README.SSL.md SECURITY.md CHANGELOG.md

%files plugin
%defattr(755,%{nsusr},%{nsgrp})
%{_libexecdir}
%defattr(644,%{nsusr},%{nsgrp})
%doc LEGAL README.md CHANGELOG.md

%changelog
* Tue Mar 07 2023 Alex Rocher <arocher@fr.scc.com> - 4.1.0-0.rgm
